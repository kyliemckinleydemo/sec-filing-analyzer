...
const SECTOR_MODELS: Record<string, SectorModel> = {
  ...
  'Consumer Discretionary': {
    ...
    weights: {
      priceToLow              : -0.0032,
      majorDowngrades         : +0.0071,
      analystUpsidePotential  : +0.0429,
      priceToHigh             : -0.0018,
      concernLevel            : +0.0050,
      marketCap               : +0.0021,
      sentimentScore          : -0.0054,
  ...
  'Consumer Staples': {
    ...
    weights: {
      ...
      analystUpsidePotential  : +0.0199,
      priceToHigh             : +0.0039,
      concernLevel            : -0.0063,
      marketCap               : -0.0043,
      sentimentScore          : +0.0062,
      upgradesLast30d         : +0.0007,
  ...
  'Energy': {
    ...
    weights: {
      ...
      filingTypeFactor        : -0.0223,
      toneChangeDelta         : -0.0056,
    },
    scorePercentiles: {
      p10: -0.0333,
      p25: -0.0228,
...
const COMBINED_MODELS: Record<string, SectorModel> = {
  ...
  'Industrials:large': {
    ...
    weights: {
      priceToLow              : -0.0023,
      majorDowngrades         : -0.0020,
      analystUpsidePotential  : +0.0207,
      priceToHigh             : -0.0037,
      concernLevel            : -0.0001,
      marketCap               : +0.0007,
      sentimentScore          : +0.0012,
      upgradesLast30d         : -0.0067,
  ...
  'Healthcare:large': {
    ...
    weights: {
      priceToLow              : +0.0011,
      majorDowngrades         : -0.0018,
      analystUpsidePotential  : +0.0150,
      priceToHigh             : -0.0071,
      concernLevel            : +0.0022,
      marketCap               : +0.0038,
      sentimentScore          : -0.0000,
      upgradesLast30d         : +0.0053,
  ...
  'Financials:mid': {
    ...
    weights: {
      priceToLow              : -0.0050,
      majorDowngrades         : -0.0013,
      analystUpsidePotential  : +0.0040,
      priceToHigh             : +0.0055,
      concernLevel            : +0.0094,
      marketCap               : +0.0037,
      sentimentScore          : +0.0010,
      upgradesLast30d         : -0.0038,
      filingTypeFactor        : -0.0009,
  ...
  'Consumer Discretionary:large': {
    ...
    weights: {
      priceToLow              : +0.0020,
      majorDowngrades         : +0.0117,
      analystUpsidePotential  : +0.0179,
      priceToHigh             : +0.0010,
      concernLevel            : -0.0011,
      marketCap               : -0.0015,
  ...
  'Financials:large': {
    ...
    weights: {
      priceToLow              : -0.0054,
      majorDowngrades         : -0.0057,
      analystUpsidePotential  : +0.0060,
      priceToHigh             : -0.0010,
      concernLevel            : -0.0017,
      marketCap               : +0.0027,
      sentimentScore          : -0.0048,
      upgradesLast30d         : +0.0025,
      filingTypeFactor        : -0.0048,
      toneChangeDelta         : -0.0016,
    },
    scorePercentiles: {
      p10: -0.0179,
  ...
  'Industrials:mid': {
    ...
    weights: {
      priceToLow              : -0.0071,
      majorDowngrades         : +0.0055,
      analystUpsidePotential  : +0.0170,
      priceToHigh             : -0.0017,
      concernLevel            : -0.0036,
      marketCap               : -0.0003,
  ...
  'Technology:mega': {
    ...
    weights: {
      ...
      upgradesLast30d         : -0.0043,
      filingTypeFactor        : -0.0031,
      toneChangeDelta         : -0.0028,
    },
    scorePercentiles: {
      p10: -0.0124,
      p25: -0.0084,
